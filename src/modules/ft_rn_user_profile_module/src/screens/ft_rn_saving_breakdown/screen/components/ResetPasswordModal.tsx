...
const sureImg = require('../res/images/sure.png');
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            ...
            <Text style={styles.sureText}>Are you sure you want to reset your password?</Text>
            <TouchableOpacity onPress={() => resetPassword()} style={styles.button}><Text style={{color: 'white'}}>Yes</Text></TouchableOpacity>
            <TouchableOpacity onPress={() => hide()} style={styles.button}><Text style={{color: 'white'}}>No</Text></TouchableOpacity>
          </View>
        </View>
      </Modal>
    );
