...
import { selectCurrentLocation, selectLocation } from "../../../../../../../../redux/location/location.selectors";
import {selectMapOutletList} from "../../../../../../../../redux/outletNotPersisted/outletNotPersisted.selectors";
        ...
        >
          ...
          >
            ...
            <View style={{ marginLeft: 5, padding: 5 }}>
              ...
              <CustomText style={{ textAlign: isRTL ? 'right' : "left", fontSize: 12, ...getFlipForRTLStyle }}>
                {distance}
              </CustomText>
            </View>
          </View>
...
class index extends Component {
  ...
  state = {
    ...
    selectedPin: null,
    googleMapAPIkey:
    "AIzaSyDv84jPwluM302tmua8wuVHNVM8B32xCtI&v=3.exp&libraries=geometry,drawing,places",
  };
  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        <MapView
          apiKey={this.state.googleMapAPIkey}
          ref={(map) => {
            this.map = map;
          }}
          style={styles.map}
        ...
        >
          {markerArray.map((markerItem) => {
            return (
              ...
              >
                <Image source={{uri:this.props.category.pinUrl}} style={{resizeMode:'contain',height:40,width:30}} />
                </Marker>
            );
          })}
        </MapView>
        {selectedPin
          ? selectedPinDetail(this.props.currentLocation, selectedPin, onOutletClick)
          : null}
      </View>
    );
  }
