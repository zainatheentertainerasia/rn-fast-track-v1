...
class DatePicker extends Component {
  ...
  render() {
    ...
    let maxDateObj = maxDate && this.getDate(maxDate);
    let minDateObj = minDate && this.getDate(minDate);
    if (Platform.OS === "ios") {
      return (
        <BottomSheet
...
DatePicker.defaultProps = { androidMode: "default" };
