...
import { english, arabic } from '../../../design/res/countries/static';
...
export default class ErrorModal extends Component<any, STATE> {
  ...
  render() {
    const { isVisible, handleDone, countries, i18n, isRTL, title } = this.props;
    console.log(isRTL);
    return (
      <Modal
        isVisible={isVisible}
      ...
      >
        <View style={[styles.cmParent]}>
          ...
          <View style={{ flex: 1 }}>
            <FlatList
              data={isRTL === false ? english.countries : arabic.countries}
          ...
          <View style={styles.cmFooterParent}>
            ...
            >
              <Text style={styles.textStyle}>{i18n.t('DONE_STRING')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
